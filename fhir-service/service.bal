...
import ballerina_fhir_server.request_handlers;
...
service /fhir/r4/Appointment on new fhirr4:Listener(config = r4_api_config:appointmentApiConfig) {
    ...
    isolated resource function get [string id](r4:FHIRContext fhirContext) returns Appointment|r4:OperationOutcome|r4:FHIRError {
        r4:Resource | r4:OperationOutcome | r4:FHIRError result = request_handlers:get_current_resource_state(id, fhirContext);
        if (result is Appointment) {
            // Handle the successful case
            return <Appointment> result;
        } else if (result is r4:OperationOutcome) {
            // Handle the OperationOutcome case
            return <r4:OperationOutcome> result;
        } else {
            // Handle the FHIRError case
